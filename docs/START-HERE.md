...
|---|---|---|
| ⚡ [docs/prompt-queue/](./prompt-queue/README.md) | **Saat Eksekusi Vibe Coding (Fase 2-4)** | Antrean prompt terpisah per modul yang sudah terisi nama modul dan controller sumber. |
